...
import com.wenming.springboot.constant.ResultBean;
...
public class LoginController {
	...
	Object login(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		if (currentUser.isAuthenticated()) {
			...
			return new ResultBean(false,ResultCode.USERNAME_OR_PASSWORD_ERROR);
		}
	}
